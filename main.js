...
var author$project$Main$stepUrl = function (model) {
	var replacePath = function (param) {
		if (param.$ === 'Just') {
			var path = param.a;
	...
	return A2(
		...
		_Utils_Tuple2(
			_Utils_update(
				...
				{page: author$project$Main$NotFound}),
			elm$core$Platform$Cmd$none),
		A2(elm$url$Url$Parser$parse, parser, model.url));
};
...
var author$project$Main$showMenu = function (page) {
	return _List_fromArray(
		[
			A2(
			elm$html$Html$li,
											...
											[
												...
												_List_fromArray(
													[
														...
														_Utils_Tuple2('hide-on-med-and-down', true)
													]))
											]),
...
var author$project$Page$Gallery$Image = F4(
	function (modalId, thumbnail, artwork, description) {
		return {artwork: artwork, description: description, modalId: modalId, thumbnail: thumbnail};
	});
...
var author$project$Page$Gallery$imagesBefore2012 = _List_fromArray(
	[
		...
		A4(author$project$Page$Gallery$Image, 'b2011-02', 'pics/before2012/cell_cyclemini.png', 'pics/before2012/cell_cycle.png', 'the cell cycle'),
		A4(author$project$Page$Gallery$Image, 'b2011-03', 'pics/before2012/鳥獣戯画風mini.png', 'pics/before2012/鳥獣戯画風.png', '鳥獣戯画風01'),
		A4(author$project$Page$Gallery$Image, 'b2011-04', 'pics/before2012/鳥獣戯画風revmini.png', 'pics/before2012/鳥獣戯画風rev.png', '鳥獣戯画風02'),
		A4(author$project$Page$Gallery$Image, 'b2011-05', 'pics/before2012/maymini.png', 'pics/before2012/may.png', '五月晴れ'),
		A4(author$project$Page$Gallery$Image, 'b2011-06', 'pics/before2012/二重盲検法mini.png', 'pics/before2012/二重盲検法.png', '二重猛犬法-double blind test-'),
...
var author$project$Page$Gallery$makeModal = function (image) {
	return A2(
		elm$html$Html$div,
		_List_fromArray(
			[
				elm$html$Html$Attributes$class('col l2')
			]),
		_List_fromArray(
			[
				A2(
				...
				_List_fromArray(
					[
						...
						elm$html$Html$Attributes$href('#' + image.modalId)
					]),
				_List_fromArray(
					[
						A2(
						...
						_List_fromArray(
							[
								...
								elm$html$Html$Attributes$src(image.thumbnail)
							]),
						_List_Nil)
					])),
				A2(
				...
				_List_fromArray(
					[
						elm$html$Html$Attributes$class('modal modal-fixed-footer'),
						elm$html$Html$Attributes$id(image.modalId)
					]),
				_List_fromArray(
					[
						A2(
...
var author$project$Page$Links$view = function (model) {
	return A2(
		elm$html$Html$div,
		_List_Nil,
		_List_fromArray(
	...
	switch (page.$) {
		...
		case 'Gallery':
			...
			return A2(
				...
				author$project$Page$Gallery$view(model));
		case 'Biography':
			var model = page.a;
			return A2(
				elm$html$Html$map,
